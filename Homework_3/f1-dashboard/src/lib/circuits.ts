...
export const CIRCUITS: Record<string, CircuitInfo> = {
  ...
  "Kuala Lumpur": { lat: 2.76083, lng: 101.738, country: "Malaysia", countryCode: "MY", circuit: "Sepang International Circuit" },
  ...
  Madrid: { lat: 40.46528, lng: -3.61528, country: "Spain", countryCode: "ES", circuit: "Madring" },
  ...
  Montreal: { lat: 45.5, lng: -73.5228, country: "Canada", countryCode: "CA", circuit: "Circuit Gilles Villeneuve" },
  ...
  Spa: { lat: 50.4372, lng: 5.9714, country: "Belgium", countryCode: "BE", circuit: "Circuit de Spa-Francorchamps" },
  ...
  "Abu Dhabi": { lat: 24.4672, lng: 54.6031, country: "United Arab Emirates", countryCode: "AE", circuit: "Yas Marina Circuit" },
